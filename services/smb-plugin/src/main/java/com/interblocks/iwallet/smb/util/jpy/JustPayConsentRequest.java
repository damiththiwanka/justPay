...
public class JustPayConsentRequest {
    ...
    @JsonProperty("CustConsent")
    private String custConsent;



    public JustPayConsentRequest() {
    }

//    public JustPayConsentRequest(IMobileProperties iMobileProperties, String nic,String referenceId,String consent){
